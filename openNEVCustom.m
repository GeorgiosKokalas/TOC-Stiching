% function name: openNEVCustom
% Purpose: A lightweight version of openNEV for extracting comments only
% Called by: TaskSticher_MAIN 
% Inputs:
%   - fileFullPath: a string containing the absolute address to the NEV
%                   file to read comments from.
% Outputs:
%   - Comments: a structure holding the comments of the files.

function Comments = openNEVCustom(fileFullPath)
    Comments = struct;
